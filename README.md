...
4. go to settings and check the languages setting (DE = german, EN = english)
5. activate Aion Chat.log with `chatlog on`
6. [optional] set the setting `check_chatlog_active` to 1
7. start Aion
8. use the dmg commands to get informations
...
| Name | Description |
|------|-------------|
|languarge|languarge of the Aion client (DE, EN)|
